        ...
        <CommandList>
          ...
          <CommandGroup heading="Pages">
            {[
              ...
              { label: "Inventory", icon: <Image src="/LO.png" alt="Stryk" width={16} height={16} className="mr-2 size-4 rounded" />, href: "/vendor/inventory" },
              { label: "Installment Plan Agreements", icon: <UserIcon className="mr-2 size-4" />, href: "/vendor/agreements" },
              { label: "My Agreements", icon: <Image src="/LO.png" alt="Stryk" width={16} height={16} className="mr-2 size-4 rounded" />, href: "/consumer/leases" },
