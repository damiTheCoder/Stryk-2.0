        ...
        <CommandList>
          ...
          <CommandGroup heading="Pages">
            {[
              ...
              { label: "Inventory", icon: <Image src="/brand-logo.png" alt="Stryk" width={16} height={16} className="mr-2 size-4 rounded-full border border-black" />, href: "/vendor/inventory" },
              { label: "Installment Plan Agreements", icon: <UserIcon className="mr-2 size-4" />, href: "/vendor/agreements" },
              { label: "My Agreements", icon: <Image src="/brand-logo.png" alt="Stryk" width={16} height={16} className="mr-2 size-4 rounded-full border border-black" />, href: "/consumer/leases" },
