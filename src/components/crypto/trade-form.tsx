    ...
    <Card className="lg:col-span-4">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex items-center gap-2 rounded-lg border border-input bg-input px-2.5">
            <Input
              type="number"
              value={amount}
              onChange={(e) => setAmount(e.target.value)}
              disabled={loading || success}
              className="h-10 border-0 bg-input px-0 text-base font-semibold tabular-nums shadow-none focus-visible:ring-0"
            />
            {isBuyMode ? (
              ...
              <Select value={fromCoin} onValueChange={(v) => v && setFromCoin(v)} disabled={loading || success}>
                <SelectTrigger size="sm" className="w-auto shrink-0 border-0 bg-input shadow-none">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
