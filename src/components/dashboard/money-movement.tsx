        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="flex items-center gap-2.5 rounded-xl bg-blue-50 px-3 py-2.5 dark:bg-blue-950/30">
            <div className="flex size-8 items-center justify-center rounded-lg bg-blue-100 dark:bg-blue-900/50">
              <ArrowDownLeftIcon className="size-4 text-blue-600 dark:text-blue-400" />
            </div>
            <div>
              <p className="text-[10px] font-medium text-blue-600/70 dark:text-blue-400/70">Collections</p>
          ...
          <div className="flex items-center gap-2.5 rounded-xl bg-blue-50 px-3 py-2.5 dark:bg-blue-950/30">
            <div className="flex size-8 items-center justify-center rounded-lg bg-blue-100 dark:bg-blue-900/50">
              <ArrowUpRightIcon className="size-4 text-blue-600 dark:text-blue-400" />
            </div>
            <div>
              <p className="text-[10px] font-medium text-blue-600/70 dark:text-blue-400/70">Payouts</p>
              <p className="text-sm font-bold tabular-nums text-blue-700 dark:text-blue-300">
