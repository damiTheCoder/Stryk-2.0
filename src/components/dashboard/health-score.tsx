...
const factorIcons: Record<string, React.ReactNode> = {
  hf1: <Image src="/LO.png" alt="Stryk" width={16} height={16} className="size-4 rounded" />,
  hf2: <ShieldIcon className="size-4" />,
  hf3: <TrendingUpIcon className="size-4" />,
  hf4: <LineChartIcon className="size-4" />,
  hf5: <PiggyBankIcon className="size-4" />,
  hf6: <ReceiptIcon className="size-4" />,
}

const statusColor = {
  excellent: { text: "text-blue-600 dark:text-blue-400", bg: "bg-blue-500/10", fill: "#3b82f6" },
  good: { text: "text-blue-500 dark:text-blue-400", bg: "bg-blue-500/10", fill: "#3b82f6" },
  fair: { text: "text-blue-400 dark:text-blue-300", bg: "bg-blue-500/10", fill: "#60a5fa" },
  poor: { text: "text-red-600 dark:text-red-400", bg: "bg-red-500/10", fill: "#ef4444" },
}
