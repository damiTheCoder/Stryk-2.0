        ...
        <div className="relative z-20 mt-auto p-8">
          <div className="rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
            <blockquote className="text-sm leading-relaxed text-white/80">
              &ldquo;Enable installment plans for your customers in minutes. Get paid instantly in <span className="inline-flex items-center gap-1"><USDCIcon /></span>.&rdquo;
            </blockquote>
            <p className="mt-3 text-xs text-white/50">— Stryk Installment Plans</p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="text-center">
            ...
            <p className="mt-1.5 text-sm text-muted-foreground">
              Set up your business to start offering installment plans
            </p>
          </div>
