...
export default function CustomerDetailPage() {
  ...
  return (
    <div className="flex flex-1 flex-col gap-4 overflow-x-hidden md:p-6 md:pt-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                Customer ID: {customerId} · {customerLeases.length} installment plan agreement{customerLeases.length !== 1 ? "s" : ""}
              </p>
            </div>
          </div>
        </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">Installment Plan Agreements</CardTitle>
        </CardHeader>
        <CardContent>
