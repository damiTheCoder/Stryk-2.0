...
const metrics = [
  { title: "Total Payouts", value: <span className="inline-flex items-center gap-1.5"><USDCIcon /> {formatUSDC(vendorMetrics.totalPayouts)}</span>, icon: <Image src="/LO.png" alt="Stryk" width={16} height={16} className="size-4 rounded-full text-blue-600" /> },
