    ...
    return (
      <div className="flex flex-1 items-center justify-center p-4 text-center">
        <div>
          ...
          <p className="mt-2 text-muted-foreground">This installment plan agreement link is invalid or has expired.</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="flex flex-1 flex-col gap-6 p-4 pt-0">
      <div className="text-center">
        ...
        <h1 className="mt-4 text-2xl font-semibold tracking-tight">Installment Plan Agreement</h1>
        <p className="text-muted-foreground text-sm">
          Review your payment plan and sign to accept this installment plan agreement.
        </p>
      </div>
